...
const Hero = () => {
  ...
  return (
    <div className='h-full'>
      <div className='border-b border-b-outline pl-5 py-3 flex flex-row items-center text-textColor text-sm'>
      ...
      <div className='h-[92%] grid md:grid-cols-2 grid-cols-1'>
        <div className='col-span-1 border-r border-r-outline pt-5'>
          <Input
        ...
        <div className='col-span-1 bg-grey-400 pt-10'>
